...
describe('Login Use Case', () => {
    ...
    it('should return jsonwebtoken response', async () => {
        ...
        const loginUseCase = new LoginUseCase(testUserRepository, createHashService, createTokenService)
    ...
    it('should throw an error if try create an User with the same email', async () => {
        ...
        expect(loginUseCase.execute(login_wrong_payload)).rejects.toThrow("E-mail/Password is incorrect!")
    })
})