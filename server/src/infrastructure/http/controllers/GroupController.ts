...
class GroupController {
    constructor(private createMonitGroupUseCase: CreateMonitGroupUseCase, private getAllGroupsUseCase: GetAllGroupsUseCase) { }
    ...
    async createGroup(req: Request, resp: Response) {
        try {
            ...
            const response = await this.createMonitGroupUseCase.execute(valid_body, { user_id, role })
    ...
    async findAllGroups(req: Request, resp: Response) {
        try {
            ...
            const response = await this.getAllGroupsUseCase.execute({ user_id, role }, params)
